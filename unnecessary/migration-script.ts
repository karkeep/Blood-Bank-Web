// migration-script.ts - Script to migrate data from PostgreSQL to Firebase Realtime Database
  ...
  try {
    ...
    for (const record of donationRecords) {
      ...
      const recordData: any = {
        ...
        donationDate: record.donationDate?.toISOString() || new Date().toISOString()
      };
